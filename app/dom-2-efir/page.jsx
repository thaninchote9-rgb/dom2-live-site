export const metadata = {
  title: "Дом 2 эфир — смотреть актуальный стрим онлайн",
  description: "Актуальный эфир Дом 2, свежий стрим, YouTube-плеер, архив выпусков и новости проекта.",
  alternates: { canonical: "https://dom2-live.ru/dom-2-efir" },
  openGraph: {
    title: "Дом 2 эфир — смотреть актуальный стрим онлайн",
    description: "Актуальный эфир Дом 2, свежий стрим, YouTube-плеер, архив выпусков и новости проекта.",
    url: "https://dom2-live.ru/dom-2-efir",
    siteName: "Дом 2 Live",
    type: "website",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 bg-[url('/backgrounds/rain-window.webp')] bg-cover bg-center bg-fixed text-slate-950">
      ...
      <div className="relative z-10 mx-auto max-w-[1120px] px-4 py-10 md:px-6 md:py-14">
        ...
        <section className="rounded-[2rem] border border-white/75 bg-white/82 p-7 shadow-[0_24px_90px_rgba(15,23,42,0.32)] backdrop-blur-3xl md:p-10">
          ...
          <h1 className="mb-5 text-4xl font-black leading-tight text-slate-950 md:text-6xl">Дом 2 эфир</h1>
          <p className="max-w-3xl text-lg leading-8 text-slate-700">Эта страница посвящена актуальному эфиру Дом 2. Здесь можно быстро перейти к просмотру свежего стрима и архивным выпускам.</p>
          <div className="mt-7 flex flex-wrap gap-3">
              <span className="rounded-full border border-white/70 bg-white/80 px-4 py-2 text-sm font-black text-slate-700 shadow-md backdrop-blur-xl">дом 2 эфир</span>
              <span className="rounded-full border border-white/70 bg-white/80 px-4 py-2 text-sm font-black text-slate-700 shadow-md backdrop-blur-xl">дом 2 стрим</span>
              <span className="rounded-full border border-white/70 bg-white/80 px-4 py-2 text-sm font-black text-slate-700 shadow-md backdrop-blur-xl">дом 2 прямой эфир</span>
              <span className="rounded-full border border-white/70 bg-white/80 px-4 py-2 text-sm font-black text-slate-700 shadow-md backdrop-blur-xl">дом 2 смотреть эфир</span>
          </div>
