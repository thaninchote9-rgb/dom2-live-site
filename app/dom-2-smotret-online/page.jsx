export const metadata = {
  ...
  description: "Смотрите Дом 2 онлайн: свежие выпуски, актуальный эфир, архив стримов и новости участников проекта.",
  alternates: { canonical: "https://dom2-live.ru/dom-2-smotret-online" },
  openGraph: {
    title: "Дом 2 смотреть онлайн — свежий выпуск сегодня",
    description: "Смотрите Дом 2 онлайн: свежие выпуски, актуальный эфир, архив стримов и новости участников проекта.",
    url: "https://dom2-live.ru/dom-2-smotret-online",
    siteName: "Дом 2 Live",
    type: "website",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 bg-[url('/backgrounds/rain-window.webp')] bg-cover bg-center bg-fixed text-slate-950">
      ...
      <div className="relative z-10 mx-auto max-w-[1120px] px-4 py-10 md:px-6 md:py-14">
        ...
        <section className="rounded-[2rem] border border-white/75 bg-white/82 p-7 shadow-[0_24px_90px_rgba(15,23,42,0.32)] backdrop-blur-3xl md:p-10">
          ...
          <h1 className="mb-5 text-4xl font-black leading-tight text-slate-950 md:text-6xl">Дом 2 смотреть онлайн</h1>
          <p className="max-w-3xl text-lg leading-8 text-slate-700">На этой странице собрана удобная навигация для просмотра свежих выпусков Дом 2 онлайн. Здесь можно перейти к актуальному эфиру, архиву выпусков и новостям участников.</p>
          <div className="mt-7 flex flex-wrap gap-3">
              <span className="rounded-full border border-white/70 bg-white/80 px-4 py-2 text-sm font-black text-slate-700 shadow-md backdrop-blur-xl">дом 2 смотреть онлайн</span>
              <span className="rounded-full border border-white/70 bg-white/80 px-4 py-2 text-sm font-black text-slate-700 shadow-md backdrop-blur-xl">дом 2 онлайн</span>
