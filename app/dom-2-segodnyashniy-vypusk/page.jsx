export const metadata = {
  title: "Дом 2 сегодняшний выпуск — смотреть онлайн",
  description: "Дом 2 сегодняшний выпуск — смотреть онлайн: свежие выпуски, сегодняшний эфир, архив и новости участников проекта.",
  alternates: { canonical: "https://dom2-live.ru/dom-2-segodnyashniy-vypusk" },
};
    ...
    <nav className="hidden rounded-full bg-gradient-to-r from-sky-400 via-cyan-300 to-violet-500 p-[2px] shadow-[0_0_26px_rgba(56,189,248,0.45),0_0_38px_rgba(139,92,246,0.28)] md:flex">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 pb-12 pt-28 md:px-6 md:pt-32">
        <section className="rounded-[2rem] border border-white/80 bg-white/86 p-7 shadow-[0_24px_90px_rgba(15,23,42,0.22)] backdrop-blur-3xl md:p-10">
          ...
          <h1 className="mb-5 text-4xl font-black leading-tight text-slate-950 md:text-6xl">Дом 2 сегодняшний выпуск</h1>
          <p className="max-w-3xl text-lg leading-8 text-slate-800">На этой странице собраны быстрые переходы к актуальному эфиру, архиву выпусков и свежим новостям Дом 2. Раздел создан для зрителей, которые ищут дом 2 сегодняшний выпуск.</p>
          <div className="mt-7 flex flex-wrap gap-3"><span className="rounded-full border border-white/80 bg-white/80 px-4 py-2 text-sm font-black text-slate-800 shadow-md">дом 2 сегодняшний выпуск</span>
<span className="rounded-full border border-white/80 bg-white/80 px-4 py-2 text-sm font-black text-slate-800 shadow-md">дом 2 смотреть онлайн сегодняшний</span>
<span className="rounded-full border border-white/80 bg-white/80 px-4 py-2 text-sm font-black text-slate-800 shadow-md">дом 2 сегодня</span></div>
