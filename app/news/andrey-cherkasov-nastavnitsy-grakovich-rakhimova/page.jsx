export const metadata = {
  title: "Андрей Черкасов подтвердил роль наставниц Гракович и Рахимовой — Дом 2",
  description: "Андрей Черкасов подтвердил, что Вероника Гракович и Элина Рахимова помогают молодёжному коллективу на проекте Дом-2 в роли наставниц.",
  alternates: {
    canonical: "https://dom2-live.ru/news/andrey-cherkasov-nastavnitsy-grakovich-rakhimova",
  },
  openGraph: {
    title: "Андрей Черкасов подтвердил роль наставниц Гракович и Рахимовой",
    description: "Зрители давно интересовались функциями тандема Вероники Гракович и Элины Рахимовой на поляне. Черкасов подтвердил их наставническую роль.",
    url: "https://dom2-live.ru/news/andrey-cherkasov-nastavnitsy-grakovich-rakhimova",
    type: "article",
    images: ["/news/news-cherkasov-grakovich-rakhimova.png"],
  },
};
    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(219,234,254,0.95),transparent_34%),radial-gradient(circle_at_top_right,rgba(243,232,255,0.90),transparent_36%),radial-gradient(circle_at_bottom_left,rgba(224,242,254,0.92),transparent_38%),linear-gradient(135deg,#eef6ff_0%,#f8fbff_48%,#f4efff_100%)] text-slate-950">
      ...
      <article className="relative z-10 mx-auto max-w-4xl px-4 pb-12 pt-28 md:px-6 md:pb-16 md:pt-32">
        ...
        <section className="overflow-hidden rounded-[2rem] border border-white/80 bg-white/88 shadow-[0_24px_90px_rgba(15,23,42,0.30)] backdrop-blur-3xl">
          <img
            src="/news/news-cherkasov-grakovich-rakhimova.png"
            alt="Вероника Гракович и Элина Рахимова на проекте Дом-2"
          ...
          <div className="p-6 md:p-10">
            ...
            <p className="mb-5 text-lg leading-8 text-slate-800">
              Зрители Дома-2 давно интересуются теми функциями, которые выполняет тандем Вероники Гракович и Элины Рахимовой на поляне в молодёжном коллективе.
            </p>

            <p className="mb-5 text-lg leading-8 text-slate-800">
              Андрей Черкасов подтвердил, что девушки действительно находятся на проекте не просто как участницы обсуждений, а помогают молодым ребятам в роли наставниц.
            </p>

            <p className="mb-5 text-lg leading-8 text-slate-800">
              Такой формат объясняет, почему Гракович и Рахимова часто оказываются рядом с новыми участниками, комментируют ситуации на поляне и помогают разбирать конфликты внутри коллектива.
            </p>

            <p className="text-lg leading-8 text-slate-800">
              Теперь зрителям стало понятнее, зачем проекту нужен этот тандем. Обсуждение роли наставниц продолжается, а поклонники Дома-2 следят, как это повлияет на атмосферу в молодёжном составе.
            </p>
