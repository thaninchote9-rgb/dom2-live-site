export const metadata = {
  title: "Карина Титуева покинула проект Дом-2 — Дом 2 Live",
  description: "Карина Титуева покинула телепроект Дом-2 после скандала и ушла за периметр, так и не построив любовь на проекте.",
  alternates: {
    canonical: "https://dom2-live.ru/news/karina-titueva-pokinula-proekt-dom-2",
  },
  openGraph: {
    title: "Карина Титуева покинула проект Дом-2 — Дом 2 Live",
    description: "Карина Титуева покинула телепроект Дом-2 после скандала и ушла за периметр, так и не построив любовь на проекте.",
    url: "https://dom2-live.ru/news/karina-titueva-pokinula-proekt-dom-2",
    images: ["https://dom2-live.ru/news/news-karina-titueva-left-project.jpg"],
    type: "article",
  },
};
      ...
      <article className="relative z-10 mx-auto max-w-4xl px-4 pb-12 pt-28 md:px-6 md:pb-16 md:pt-32">
        ...
        <section className="overflow-hidden rounded-[2rem] border border-white/80 bg-white/90 shadow-[0_24px_90px_rgba(15,23,42,0.38)] backdrop-blur-3xl">
          <div className="relative">
            <img src="/news/news-karina-titueva-left-project.jpg" alt="Карина Титуева покинула проект Дом-2" className="max-h-[620px] w-full object-cover object-center" />
            ...
            <div className="absolute right-4 top-4 rounded-full bg-slate-950 px-4 py-2 text-sm font-black text-white shadow-lg">01.06.2026</div>
          </div>

          <div className="p-6 md:p-10">
            <div className="mb-3 text-sm font-black uppercase tracking-[0.22em] text-slate-700">новость дом 2</div>
            <h1 className="mb-5 text-3xl font-black leading-tight text-slate-950 md:text-5xl">Карина Титуева покинула проект Дом-2</h1>

            <div className="mb-6 flex flex-wrap gap-3 text-sm font-bold text-slate-700">
              <span className="rounded-full bg-slate-100 px-4 py-2">Дата публикации: 01.06.2026</span>
            ...
            <div className="space-y-5 text-base leading-8 text-slate-800 md:text-lg">
              <p>Участница Дома-2 Карина Титуева покинула телепроект после скандала. Так и не построив любовь на проекте, Карина ушла за периметр.</p>
              <p>Новость быстро стала темой для обсуждения среди зрителей. Многие следили за развитием ситуации и теперь обсуждают, как уход Карины повлияет на дальнейшие события на поляне.</p>
              <p>Дом 2 Live собирает свежие новости участников в отдельном разделе, чтобы каждую важную публикацию можно было открыть по прямой ссылке, добавить в поиск и отслеживать через аналитику.</p>
            </div>
            ...
            <div className="mt-8 grid gap-3 rounded-[1.5rem] border border-slate-200 bg-slate-50/80 p-4 md:grid-cols-3">
              ...
              <a href="/news/sergey-horoshev-zhenya-uletela-iz-kitaya" className="rounded-2xl bg-white px-4 py-3 text-center text-sm font-black text-slate-800 shadow-sm hover:bg-slate-100">Сергей Хорошев сообщил, что Женя улетела из Китая</a>
