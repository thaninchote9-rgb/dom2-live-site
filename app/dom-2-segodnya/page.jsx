export const metadata = {
  title: "Дом 2 сегодня — сегодняшний выпуск и свежий эфир",
  description: "Дом 2 сегодня: сегодняшний выпуск, свежий эфир, новости участников и архив предыдущих серий.",
  alternates: { canonical: "https://dom2-live.ru/dom-2-segodnya" },
  openGraph: {
    title: "Дом 2 сегодня — сегодняшний выпуск и свежий эфир",
    description: "Дом 2 сегодня: сегодняшний выпуск, свежий эфир, новости участников и архив предыдущих серий.",
    url: "https://dom2-live.ru/dom-2-segodnya",
    siteName: "Дом 2 Live",
    type: "website",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 bg-[url('/backgrounds/rain-window.webp')] bg-cover bg-center bg-fixed text-slate-950">
      ...
      <div className="relative z-10 mx-auto max-w-[1120px] px-4 py-10 md:px-6 md:py-14">
        ...
        <section className="rounded-[2rem] border border-white/75 bg-white/82 p-7 shadow-[0_24px_90px_rgba(15,23,42,0.32)] backdrop-blur-3xl md:p-10">
          ...
          <h1 className="mb-5 text-4xl font-black leading-tight text-slate-950 md:text-6xl">Дом 2 сегодня</h1>
          <p className="max-w-3xl text-lg leading-8 text-slate-700">Здесь собрана информация для зрителей, которые ищут сегодняшний выпуск Дом 2 и хотят быстро перейти к актуальному эфиру.</p>
          <div className="mt-7 flex flex-wrap gap-3">
              ...
              <span className="rounded-full border border-white/70 bg-white/80 px-4 py-2 text-sm font-black text-slate-700 shadow-md backdrop-blur-xl">дом 2 сегодняшний выпуск</span>
              <span className="rounded-full border border-white/70 bg-white/80 px-4 py-2 text-sm font-black text-slate-700 shadow-md backdrop-blur-xl">дом 2 свежий эфир</span>
              <span className="rounded-full border border-white/70 bg-white/80 px-4 py-2 text-sm font-black text-slate-700 shadow-md backdrop-blur-xl">дом 2 эфир сегодня</span>
          </div>
