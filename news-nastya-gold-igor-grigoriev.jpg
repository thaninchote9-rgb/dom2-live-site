export const metadata = {
  title: "Женя Хорошева хочет развестись с Сергеем — новости Дом 2",
  description: "Женя Хорошева заявила, что устала от конфликтов с Сергеем и хочет спокойно развестись без грязи.",
  alternates: {
    canonical: "https://dom2-live.ru/news/zhenya-horosheva-razvod-sergey",
  },
  openGraph: {
        ...
        <section className="overflow-hidden rounded-[2rem] border border-white/80 bg-white/88 shadow-[0_24px_90px_rgba(15,23,42,0.30)] backdrop-blur-3xl">
          ...
          <div className="p-6 md:p-10">
            ...
            <h1 className="mb-5 text-3xl font-black leading-tight text-slate-950 md:text-5xl">
              Женя Хорошева хочет развестись с Сергеем
            </h1>

            <p className="mb-5 text-lg leading-8 text-slate-800">
              Женя Хорошева высказалась о ситуации с Сергеем и дала понять, что устала от конфликтов в отношениях.
            </p>

            <p className="mb-5 text-lg leading-8 text-slate-800">
              По словам Жени, Сергей сам отправлял её уезжать, говорил собираться, а также швырялся вещами. После этого она написала, что «всё к лучшему», но в её сообщении явно чувствуется усталость от происходящего.
            </p>

            <p className="mb-5 text-lg leading-8 text-slate-800">
              Женя отметила, что хочет рожать детей, варить борщи и жить спокойной семейной жизнью, а не постоянно соревноваться и выяснять, кто в отношениях сильнее.
            </p>

            <p className="text-lg leading-8 text-slate-800">
              В конце она добавила, что надеется спокойно развестись без грязи. Теперь зрители обсуждают, получится ли у пары расстаться мирно или конфликт получит продолжение.
            </p>
